...
namespace App\Modules\TiposVehiculo\Services;

use App\Models\TipoVehiculo;
use App\Modules\TiposVehiculo\Data\TiposVehiculoData;
use App\Shared\Responses\ApiResponse;

class TiposVehiculoService
{
    public static function get_tipos_vehiculo(): array
    {
        $data = TiposVehiculoData::get_tipos_vehiculo();
    ...
    public static function crear_tipo_vehiculo(string $nombre, bool $tieneCarreta, bool $esCarreta): array
    {
        ...
        $nuevoTipo = TiposVehiculoData::get_tipo_vehiculo_by_id($id);
    ...
    public static function editar_tipo_vehiculo(int $id, string $nombre, bool $tieneCarreta, bool $esCarreta): array
    {
        ...
        $updated = TiposVehiculoData::get_tipo_vehiculo_by_id($id);
